...
SECRET_KEY = 'django-insecure-i@e^%f%ps3qm)-5jj(uk$qav@$!o3eksw6^dt#2c725-ae96$k'
...
BLOCKCHAIN_ACCOUNT_ADDRESS = os.environ.get(
...
BLOCKCHAIN_CONTRACT_ABI_PATH = os.environ.get(
